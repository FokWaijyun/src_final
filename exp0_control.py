...
if __name__ == '__main__':
    ...
    parser.add_argument('--tensor_board_comment', type=str, default='控制组实验', help='可视化工具文件的后缀')
    parser.add_argument('--log_dir', type=str, default='./runs/控制组实验', help='可视化工具文件文件名')
