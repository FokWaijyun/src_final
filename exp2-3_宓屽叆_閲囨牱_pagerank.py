...
if __name__ == '__main__':
    ...
    parser.add_argument('--tensor_board_comment', type=str, default='特征嵌入-嵌入—采样', help='可视化工具文件的后缀')
    parser.add_argument('--log_dir', type=str, default='./runs/特征嵌入-mlp', help='可视化工具文件文件名')
